...
const SECTIONS = ['custom', 'feedback', 'evaluation'] as const;
...
export const SchoolEvaluationQuestions = ({ schoolId }: SchoolEvaluationQuestionsProps) => {
  ...
  const [formData, setFormData] = useState({
    ...
    section: 'custom' as typeof SECTIONS[number],
    options: ''
  });
  ...
  const fetchQuestions = async () => {
    try {
      setLoading(true);
      // Get questions for this specific school
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Create custom questions for your students</p>
              </div>
            </div>
        ...
        <CardContent>
          {questions.length > 0 ? (
            ...
            <div className="text-center py-8 text-muted-foreground">
              No custom questions yet. Create one to get started.
            </div>
          )}
        </CardContent>
      </Card>
